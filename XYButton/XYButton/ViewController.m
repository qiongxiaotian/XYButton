...
@property (weak, nonatomic) IBOutlet XYButton *xibBtn;

@property (weak, nonatomic) IBOutlet XYButton *titleInsideImage;
...
- (void)viewDidLoad {
    ...
    }
    {
        ...
        _titleInsideImage.titleRect = CGRectMake(0, 50, 100, 20);
        _titleInsideImage.titleLabel.textAlignment = NSTextAlignmentCenter;
    }

    {
        XYButton * searchBtn = [XYButton buttonWithType:UIButtonTypeCustom];
    ...
    {
        XYButton * cancelBtn = [XYButton buttonWithType:UIButtonTypeCustom];
